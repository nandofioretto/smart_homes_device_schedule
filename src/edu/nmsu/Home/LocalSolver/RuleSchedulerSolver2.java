...
// */
//public class RuleSchedulerSolver2 extends CPSolver {
//
//    // Class Parameters
...
//     */
//    private FloatVar[][] var_predModel;
//
//    /**
...
//     */
//    private FloatVar[] var_aggrPower;
//
//    /**
...
//
//    private Pair<Double, Double> aggregatedPowerBounds = new Pair<>(0,0,0.0);
//    private Pair<Double, Double> aggregatedPriceBounds = new Pair<>(0.0,0.0);
//
...
//     */
//    public RuleSchedulerSolver2(String homeAgtName, ArrayList<SchedulingRule> schedulingRules, double[] bgLoadsKWh) {
//
...
//                maxPower = Math.max(maxPower, a.getPowerKWh());
//            }
//            aggrMax += maxPower;
//        }
...
//        }
//        delta  = new double[nbPredictiveModels][nbActuators][nbActions];
//        populateDeltaArray(delta);
//        power  = new double[nbActuators][nbActions];
...
//
//        double maxNeibhgoursPwConsumption = Utilities.getMax(neighborPower);
//        double minNeibhgoursPwConsumption = Utilities.getMin(neighborPower);
//        double minBgLoad = Utilities.getMin(bgLoadsKWh);
//        double maxBgLoad = Utilities.getMax(bgLoadsKWh);
//
//        ////////////////////////////////
//        // CP Declarations
//        ////////////////////////////////
...
//        // Variables
//        ////////////////////////////////
//        var_predModel = new FloatVar[PREDMODEL_SIZE][HORIZON];
//        createFloatVar2DArray(var_predModel, store, "predModel",
//                FloatDomain.MinFloat,
//                FloatDomain.MaxFloat);
//
//        var_aggrPower = new FloatVar[HORIZON];
//        createFloatVarArray(var_aggrPower, store, "aggrPower",
...
//        FloatVar objPrice = new FloatVar(store, "price",
...
//        FloatVar objPowerDiff = new FloatVar(store, "pwDiff", //0, IntDomain.MaxInt);
//                Math.pow(aggregatedPowerBounds.getFirst()  + minNeibhgoursPwConsumption, 2) * HORIZON,
//                Math.pow(aggregatedPowerBounds.getSecond() + maxNeibhgoursPwConsumption, 2) * HORIZON);
//
//        ////////////////////////////////////////////
//        // Constraints:
//        /////////////////////////////////////////////
...
//     */
//    private void populateDeltaArray(double[][][] delta) {
//
//        if (debug.delta())
...
//                    delta[mID][aID][sID] = action.getDeltaOf(sensorProperty);
//
//                    if(debug.delta()) {
...
//     */
//    private void populatePowerArray(double[][] power) {
//
//        if (debug.power())
...
//            int sID = 0;
//            for (Action action : actuator.getActions()) {
//                power[aID][sID] = action.getPowerKWh();   // transforms KW to Watt
//
//                if(debug.power())
...
//            ArrayList<FloatVar> auxVars = new ArrayList<>();
//
//            // CONSTRAINT SUM
//            for (Actuator actuator : model.getActuators()) {
//                int aID = cpActuatorId.get(actuator);
//                String name = "aux_delta_"+actuator.getName()+"(t="+t+")";
//                FloatVar vAux = new FloatVar(store, name, Utilities.getMin(delta_m[aID]), Utilities.getMax(delta_m[aID]));
//
//                // c = delta[aID][ x[aID][t] ];
//                // todo: check if t or t-1 -> when action propagates
//                int xDom = actuator.getNbActions();
//                double[] delta = Arrays.copyOf(delta_m[aID], xDom);
//
...
//            Constraint ctr = new Sum(store, auxVars, "==", var_PredModel_m[t]);
